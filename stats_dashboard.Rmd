...
The text explores mortality data from the [South African data portal]()

Use the input below to explore outputs.
...
```{r}
renderDataTable({
  datatable(mortality_zaf %>% filter(indicator == input$indicator))          
})
```
